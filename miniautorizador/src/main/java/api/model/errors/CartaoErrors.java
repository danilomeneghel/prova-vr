...
public class CartaoErrors {
    ...
    public static final ErrorModel CARD_EXISTS = new ErrorModel(HttpStatus.UNPROCESSABLE_ENTITY.value(), "400001", "Número do cartão já cadastrado. Tente novamente com outro número.");
